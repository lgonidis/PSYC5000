---
title: "Week 16 Repeated Measures ANOVA"
...
**The results of the simple main effects analyses are not all that helpful in this particular case with respect to describing the interaction effect. Perhaps the most reasonable description to offer based on the simple main effects analyses is that the differences between the four screen colours were more pronounced with high illumination than with low illumination. This description is based upon the fact that the magnitude of the obtained F-value when testing the simple main effect of screen colour within high illumination was noticeably larger than when testing for the effect of screen colour within the low illumination condition (F(3,12) = 58.5 versus F(3,12) = 41.8).**
