...
Refering back to your lecture slides, we also talked about **mean squared error**, **MSE**. This is a value that get_anova_table() does not generate by default by we can produce it by calculated the ratio of SSd by DFd.
