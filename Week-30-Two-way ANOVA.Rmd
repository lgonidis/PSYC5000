...
We will now carry out the two-way ANOVA
...
### these two approaches give different results here
gss %>% 
...
**Main effect of sex: F(1,1331) = 2.771, MSE = 15.773, p = .096**
**Main effect of degree: F(4,1331) = 61.308, MSE = 15.773, p < .001**
**Interaction between sex and degree: F(4,1331) = 3.493, MSE = 15.773, p < .01**
